...
public class LargestProduct{
 ...
 /**
  *Returns the largest product of any n consecutive digits in a number (represented as a String)
  *@param input The string to be analyzed, allowing for more digits than a pure number
 ...
 /**
  *Takes in a String representing a String of digits and returns a byte array of the digits
