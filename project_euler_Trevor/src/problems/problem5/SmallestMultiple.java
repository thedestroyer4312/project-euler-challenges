...
public class SmallestMultiple{
	...
	/**
	 * Finds the smallest positive number divisble by all numbers in a certain
	 * range
	 * @param min Indicates the starting range
	 * @param max Indicates the maximum range
	 * @return the smallest multiple evenly divisble by all numbers between min
	 * and max -- that is, the least common multiple
	 */
