...
public class evenFibonacciNumbers{
 ...
 public static void main(String[] args){
  ...
  /**
   *Finds the sum of the even-valued Fibonacci sequence numbers under a limit.
   *@param input A long which specifies the upper limit of this method.
   *@return The sum of the even-valued numbers in the Fibonacci sequence under the upper limit.
   */
