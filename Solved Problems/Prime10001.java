...
public class Prime10001{
 ...
 /**
  *Determines if a number n is a prime number using the fact that all primes can be written as 6k + i
  *Test for divisibility by 2 or 3, then with some value of k
